...
export function AboutPageContent({ showAuditCta = false }) {
  return (
...
Growth marketer for 12+ years. Co-founder & CMO of a fintech that I grew as the sole marketer from $10k to $2M ARR in two years. I'm sharing the AI systems I built to do it.
        ...
        <div className="lg:pl-20">
          <ul role="list">
            <SocialLink href="https://x.com/notanothermrktr" icon={XIcon}>
              Follow on X
            </SocialLink>
            <SocialLink
              href="https://www.instagram.com/notanothermrktr/"
              icon={InstagramIcon}
              className="mt-4"
            >
              Follow on Instagram
            ...
            <SocialLink
              href="mailto:hello@notanothermarketer.com"
              icon={MailIcon}
              className="mt-8 border-t border-zinc-100 pt-8 dark:border-zinc-700/40"
            >
              hello@notanothermarketer.com
            </SocialLink>
          </ul>
        </div>
      </div>
